...
| `nirman-milestones.md` | Development strategy, sequencing, milestones, fixtures, acceptance gates, milestone contract mappings, and implementation status (formerly `nirman-development-plan.md`) |
