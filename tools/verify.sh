...
cargo test -p nirman-skills --test m118_platform_skills_acceptance
cargo test -p nirman-control-plane --test m119_skill_registry_acceptance
...
python3 tools/check_m8_evidence.py
