# Android UI Form Validation

Scope: form validation in a generated Android application — when validation fires, message quality and placement, server errors mapped back to fields, and disabled states with a stated reason (BS §79.7).
