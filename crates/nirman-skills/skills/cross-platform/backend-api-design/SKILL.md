...
Scope: the HTTP surface a Nirman app consumes or exposes — resource modelling and naming,
versioning, error semantics, pagination, idempotency, and where authentication is
enforced (BS §79.7).
