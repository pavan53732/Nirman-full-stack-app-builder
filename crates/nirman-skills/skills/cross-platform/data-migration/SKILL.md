...
Scope: schema and data migrations for Nirman apps — ordering and versioning migrations,
staying backward compatible across a release, deciding what is reversible, and
verifying data integrity after a migration runs (BS §79.7).
