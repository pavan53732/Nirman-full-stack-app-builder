...
Scope: state management in Nirman apps — which state is owned and which is derived, how
mutations are disciplined around a single source of truth, how long state lives, and
how stale reads and duplicated state are avoided (BS §79.7).
