...
Scope: schema design for Nirman persistence — table and column modelling, key and
relationship choices, constraints and defaults, indexing against the queries actually
run, and whether a change is migration-safe (BS §79.7).
