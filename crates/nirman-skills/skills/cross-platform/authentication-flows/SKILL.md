...
Scope: authentication and session flows for Nirman apps — how credentials are handled,
how tokens are acquired and refreshed, how a session expires and is revoked, and what
the user sees when any of it fails (BS §79.7).
