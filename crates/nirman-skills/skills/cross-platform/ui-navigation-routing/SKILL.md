...
Scope: navigation and routing in Nirman surfaces — route structure and deep linking, back
and up behaviour, state preserved across navigation, and guards on destinations that
require a condition (BS §79.7).
