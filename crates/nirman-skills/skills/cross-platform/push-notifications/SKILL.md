...
Scope: push notification delivery for Nirman apps — the token lifecycle and its refresh,
how reliably delivery is retried, payload limits and structure, and the permission
states a user actually sees (BS §79.7).
