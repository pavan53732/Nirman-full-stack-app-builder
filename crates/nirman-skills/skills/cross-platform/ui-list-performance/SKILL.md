...
Scope: list and scroll performance in Nirman surfaces — recycling views and keeping keys
stable, keeping per-item work off the scroll path, the cost of loading and decoding
images, and frame health measured while scrolling (BS §79.7).
